...
export default function EditProductPage() {
  ...
  const productData: any = productResponse;

  React.useEffect(() => {
    if (productData && productData.id) {
      const existingOptions =
        productData.productOptions?.map((opt: any) => ({
          name: opt.name,
          values:
      ...
      reset({
        ...
        categoryIds:
          productData.categories?.map(
            (c: any) => c.categoryId || c.category?.id,
          ) || [],
        subCategoryIds:
          productData.subCategories?.map(
            (sc: any) => sc.subCategoryId || sc.subCategory?.id,
          ) || [],
  ...
  const handleCategoryToggle = (catId: string) => {
    ...
    if (isSelected) {
      nextCategories = selectedCategoryIds.filter((cid) => cid !== catId);
  ...
  return (
    <div
      ...
      className="w-full max-w-[1400px] mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8 animate-in fade-in duration-500"
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-sm mt-0.5">
                Update product properties, universal options, and variant
                combinations
              </p>
            </div>
          </div>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => handleCategoryToggle(cid)}
                        >
                          <X className="h-3 w-3" />
                        </button>
                      </Badge>
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2 min-h-[32px] pt-1">
                  {selectedSubCategoryIds.map((sid) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={() => handleSubCategoryToggle(sid)}
                        >
                          <X className="h-3 w-3" />
                        </button>
                      </Badge>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              <CardTitle>1. Product Options</CardTitle>
              <CardDescription>
                Modify universal attribute names and add or remove values
              </CardDescription>
            </div>
            <Button
              type="button"
          ...
          <CardContent className="space-y-6">
            {optionFields?.length === 0 ? (
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <p className="text-sm font-medium">No options defined</p>
                <p className="text-xs text-muted-foreground">
                  Click &quot;Add Option&quot; if you want to configure variant
                  attributes.
                </p>
              </div>
            ) : (
        ...
        <Card>
          <CardHeader className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>
                Re-generate combinations or manage specific variant SKUs and
                images
              </CardDescription>
            </div>
            {optionFields?.length > 0 && (
          ...
          <CardContent className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 pt-3 border-t">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xs text-muted-foreground">
                      Variant image (optional, inherits base if empty)
                    </span>
                  </div>
            ...
            {variantFields?.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-8 border rounded-xl border-dashed">
                No variants available. Use the manual selector above or click
                &quot;Generate All Combinations&quot;.
              </p>
            ) : (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                    Configured Variants ({variantFields?.length})
                  </Label>
                  <Button
                    type="button"
                    variant="ghost"
                      ...
                      >
                        ...
                        <div className="flex-1 space-y-2">
                          <div className="flex flex-wrap items-center gap-2">
                            {combValues &&
                            Object.keys(combValues)?.length > 0 ? (
