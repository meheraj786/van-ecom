...
function ShopContent() {
  ...
  const handlePageChange = (newPage: number) => {
    updateQueryParams({ page: newPage }, { scrollToTop: false });
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-12">
        ...
        {mobileFiltersOpen && (
          <div
            className="fixed inset-x-0 bottom-0 top-32 z-40 bg-black/30 lg:hidden"
            aria-hidden="true"
        ...
        <div className="flex flex-col md:pt-0 pt-20 lg:flex-row gap-10">
          <aside
            className={cn(
              ...
              "max-lg:fixed max-lg:inset-x-0 max-lg:bottom-0 max-lg:top-32 max-lg:z-50 max-lg:overflow-y-auto max-lg:bg-[#FBFAF8] max-lg:p-5 max-lg:pt-16",
