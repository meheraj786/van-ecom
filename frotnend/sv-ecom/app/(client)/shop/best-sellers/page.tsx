...
const BestSellersPage = () => {
  ...
  const products: ProductTableItem[] = rawProducts.map((prod) => ({
    id: prod.id,
    name: prod.name,
    subtitle: prod.description?.slice(0, 50) || "Lumina Premium Collection",
    price: 0,
    image:
      prod.baseImage ||
  ...
  return (
    <div className="bg-white min-h-screen pt-20">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-12">
        <div className="relative h-64 md:h-80 w-full overflow-hidden rounded-[2rem] border mb-12 bg-gray-50">
          <Image
            src="https://images.unsplash.com/photo-1441984969893-c534e9749e76?q=80&w=1200"
            alt="Best Sellers"
            fill
          ...
          <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 z-10 text-white">
            ...
            <p className="text-sm font-medium text-white/80 uppercase tracking-widest mt-2">
              Our most popular and highest rated items
            </p>
          </div>
        </div>
