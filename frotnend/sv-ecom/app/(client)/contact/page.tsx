...
export default function ContactPage() {
  ...
  const title = contactData.title || "Get in Touch with Lumina";
  const description =
  ...
  const email = contactData.mail || "support@lumina.com";
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a
                    href={`https://wa.me/${whatsappNumber.replace(/\D/g, "")}?text=${encodeURIComponent(
                      "Hello Lumina Support, I would like to inquire about...",
                    )}`}
                    target="_blank"
